...
/**
 * Test page: server: true, lazy: true (Best of both worlds)
 *
 * Expected behavior:
 * - SSR: Fetches data (waits 800ms), renders with pending=false, hasData=true
 * - Client nav: Instant (non-blocking), shows skeleton initially
 */
...
<template>
  <div data-testid="server-true-lazy-true-page" class="test-page">
    <header class="page-header">
      <NuxtLink to="/test-query/hub" class="back-link">&larr; Back</NuxtLink>
      <div class="badge-row">
        <span class="badge server">server: true</span>
