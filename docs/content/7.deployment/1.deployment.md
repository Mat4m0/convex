...
Configure your Nuxt app to use the preview URL and allow CORS for preview origins:
...
export default defineNuxtConfig({
  convex: {
    ...
    trustedOrigins: [
      'https://your-app-*.vercel.app', // Wildcard for all preview deployments
    ],
  },
})
```
...
The `trustedOrigins` option allows the auth proxy to accept requests from preview deployment URLs. Use wildcards to cover dynamic preview URLs.
::
