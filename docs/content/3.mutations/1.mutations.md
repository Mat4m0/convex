...
Execute Convex mutations with loading state, error handling, and optimistic updates.
...
::callout{icon="i-lucide-info" to="/advanced/logging"}
...
See [Optimistic Updates](/mutations/optimistic-updates) for complete patterns and helper functions.
::
...
- [Actions](/mutations/actions) - For external API calls and side effects
